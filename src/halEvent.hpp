...
{
public:
	EventDetail(event_logger::eventLevel l, pt::ptime t, event_logger::codes c) :
		level_(l),
		timeStamp_(t),
		code_(c)
	{}
	...
	pt::ptime  timeStamp() { return timeStamp_; }
...
{
public:
	EventLibtorrent(event_logger::eventLevel l, pt::ptime t, event_logger::codes c, std::wstring m) :
		EventDetail(l, t, c),
		msg_(m)
	{}
...
public:
	...
	EventGeneral(event_logger::eventLevel l, pt::ptime t, std::wstring m) :
	...
	template<typename str_t>	
	EventGeneral(event_logger::eventLevel l, pt::ptime t, str_t m) :
		EventDetail(l, t, event_logger::noEvent),
		msg_(hal::to_wstr_shim(m))
	{}
...
{
public:
	EventPeerAlert(event_logger::eventLevel l, pt::ptime t, std::wstring m) :
