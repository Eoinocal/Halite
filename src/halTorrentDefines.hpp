...
#define HALITE_VERSION						0, 3, 1, 780
#define HALITE_VERSION_STRING				"v 0.3.1 dev 780"
#define HALITE_FINGERPRINT					"HL", 0, 3, 1, 8
...
#define HAL_TORRENT_PRESENT_ALREADY			HAL_TORRENT_INT_BEGIN + 32
